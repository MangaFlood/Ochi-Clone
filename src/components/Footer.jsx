...
function Footer() {
  return (
    <div className='w-full min-h-screen bg-zinc-900 text-zinc-100 px-20 pt-40 pb-20 flex'>
      <div className='footerL w-1/2 h-[90vh] flex flex-col justify-between'>
        <div className='textContainer'>
            {[
                ...
                <div className='masker'>
                    <h1 className='uppercase text-[8vw] leading-[0.75] font-["Masker"]'>{items}</h1>
                </div>
            ))}
        </div>
        <div>
      ...
      <div className='footerR w-1/2 h-full'>
        <h1 className='uppercase text-[8vw] leading-[0.75] font-["Masker"]'>presentations</h1>
        <div className='w-full h-full flex items-center'>
            <div className=' w-full h-full flex flex-col'>
                <div className='flex flex-col pt-12 gap-5'>
                    <h1 className='tracking-tighter capitalize text-3xl font-light'>S:</h1>
                    <div className='flex flex-col leading-[1.5]'>
                        {[
                            ...
                            <a className='tracking-tighter capitalize text-2xl font-light' href="#">{items}</a>
                        ))}
                    </div>
                </div>
                <div className='flex flex-col pt-12 gap-5'>
                    <h1 className='tracking-tighter capitalize text-3xl font-light'>l:</h1>
                    <div className='flex flex-col leading-[1.5]'>
                        {[
                            "202-1965 W 4th Ave",
                            "Vancouver, Canada",
                ...
                <div className='flex flex-col pt-12 gap-5'>
                    <h1 className='tracking-tighter capitalize text-3xl font-light'>e:</h1>
                    <div className='flex flex-col leading-[1.5]'>
                        {[
                            "hello@ochi.design"
                        ].map((items, index)=>(
            ...
            <div className=''>
                <div className='flex flex-col pt-12 gap-5'>
                    <h1 className='tracking-tighter capitalize text-3xl font-light'>m:</h1>
                    <div className='flex flex-col leading-[1.5]'>
                        {[
                            "Home",
                            "Services",
                            ...
                            <a className='tracking-tighter capitalize text-nowrap text-2xl font-light' href="#">{items}</a>
                        ))}
                    </div>
                </div> 
            </div>
